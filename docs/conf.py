...
"""
help-tokens documentation build configuration file.
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Django app for linking to help pages with short tokens',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'help_tokens'),
                os.path.join(root_path, 'help_tokens/migrations')])
